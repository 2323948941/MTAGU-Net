...
for i =1:num    
    ...
    inputdata{i,1}=data_research_domain{i};
...
% clear ResXY ResYX  PhaseXY PhaseYX  data_research_domain inputdata outputdata
...
[MTAGU_Net_struct,MTAGU_Net_infor] = trainNetwork(XTrain,YTrain,lgraph,options);

%Unet_3D();        %load 3D U-Net network structure
%[Unet_3D_struct,Unet_3D_infor] = trainNetwork(XTrain,YTrain,lgraph,options);
