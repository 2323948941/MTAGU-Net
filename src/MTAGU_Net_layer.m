lgraph = layerGraph();
tempLayers = image3dInputLayer([32 32 32 1],"Name","encoderImageInputLayer");
...
lgraph = connectLayers(lgraph,"encoderImageInputLayer","Encoder-Stage-1-Conv-1");
lgraph = connectLayers(lgraph,"encoderImageInputLayer","Encoder-Stage-1-Conv-2_1");
